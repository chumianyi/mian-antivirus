...
class DnsSwitchActivity : AppCompatActivity() {
    ...
    private fun addToolContent(content: LinearLayout) {
        ...
        val button = com.google.android.material.button.MaterialButton(this).apply {
            text = "执行操作"
            setOnClickListener {
                android.widget.Toast.makeText(this@DnsSwitchActivity, "DNS切换操作已执行", android.widget.Toast.LENGTH_SHORT).show()
            }
        }
